Locales['en'] = {
  ...
  -- Salary related
  ['received_salary'] = '<FONT FACE="Balo">bạn nhận được tiền lương: ~g~$%s~s~</FONT>',
  ['received_help'] = '<FONT FACE="Balo">bạn nhận được tiền hỗ trợ: ~g~$%s~s~</FONT>',
  ['company_nomoney'] = '<FONT FACE="Balo">công ty của bạn làm việc quá kém</FONT>',
  ['received_paycheck'] = '<FONT FACE="Balo">Nhận Lương</FONT>',
  ['bank'] = '<FONT FACE="Balo">VietComBank</FONT>',
  ['account_bank'] = '<FONT FACE="Balo">Ngân Hàng</FONT>',
  ['account_black_money'] = 'Tiền Bẩn',
  ['account_money'] = '<FONT FACE="Balo">Tiền Mặt</FONT>',

  ['act_imp'] = 'không thể hành động',
  ['in_vehicle'] = 'Bạn không thể cho bất cứ điều gì với ai đó trong một chiếc xe',
  ...
  ['weapon_ak47chrome'] = 'AK-47 CHROME',
  ['weapon_carbinerifle'] = 'carbine rifle',
  ['weapon_m4a4neva'] = 'M4A4 NEVA',

function CreateExtendedPlayer(playerId, identifier, group, accounts, inventory, weight, job, job2, loadout, name, coords)
	...
	self.getLastPosition = function()
		if self.coords and self.coords.x and self.coords.y and self.coords.z then
			self.coords.x = ESX.Math.Round(self.coords.x, 1)
			self.coords.y = ESX.Math.Round(self.coords.y, 1)
			self.coords.z = ESX.Math.Round(self.coords.z, 1)
		end
